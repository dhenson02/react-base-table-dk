...
export default class ColumnManager {
        ...
        return this._cache('hasLeftFrozenColumns', () => {
            return (
                ...
                this.getVisibleColumns()
                    .some(column => column.frozen === FrozenDirection.LEFT || column.frozen === true)
            );
        });
    }
    ...
    hasRightFrozenColumns () {
        return this._cache('hasRightFrozenColumns', () => {
            return this._fixed && this.getVisibleColumns()
                .some(column => column.frozen === FrozenDirection.RIGHT);
        });
    }
    ...
    getRightFrozenColumns () {
        return this._cache('rightFrozenColumns', () => {
            ...
            return this.getVisibleColumns()
                .filter(column => column.frozen === FrozenDirection.RIGHT);
        });
    }
