...
class BaseTable extends React.PureComponent {
    ...
    renderExpandIcon ( { rowData, rowIndex, depth, onExpand } ) {
        ...
        const expanded = rowIndex >= 0 && this.getExpandedRowKeys()
            .indexOf(rowData[ rowKey ]) >= 0;
    ...
    renderRow ( { isScrolling, columns, rowData, rowIndex, style } ) {
        ...
        const rowClass = callOrReturn(rowClassName, {
            columns,
            rowData,
            rowIndex,
        });
        ...
        const className = cn(this._prefixClass('row'), rowClass, {
            ...
            [ this._prefixClass('row--expanded') ]: !!expandColumnKey && this.getExpandedRowKeys()
                .indexOf(rowKey) >= 0,
    ...
    renderRowCell ( { isScrolling, columns, column, columnIndex, rowData, rowIndex, expandIcon } ) {
        ...
        const cell = renderElement(cellRenderer ||
            <TableCell className={this._prefixClass('row-cell-text')} />, cellProps);
    ...
    renderHeader ( { columns, headerIndex, style } ) {
        ...
        const headerClass = callOrReturn(headerClassName, {
            columns,
            headerIndex,
        });
        ...
        return (
            <GridTable
                ...
                headerWidth={tableWidth + (
                    fixed ? this._verticalScrollbarSize : 0
                )}
...
BaseTable.propTypes = {
     ...
     */
    overlayRenderer: PropTypes.oneOfType([
        PropTypes.func,
        PropTypes.element,
    ]),
    /**
     ...
     */
    emptyRenderer: PropTypes.oneOfType([
        PropTypes.func,
        PropTypes.element,
    ]),
    /**
     ...
     */
    headerRenderer: PropTypes.oneOfType([
        PropTypes.func,
        PropTypes.element,
    ]),
    /**
     ...
     */
    headerProps: PropTypes.oneOfType([
        PropTypes.object,
        PropTypes.func,
    ]),
    /**
     ...
     */
    headerCellProps: PropTypes.oneOfType([
        PropTypes.object,
        PropTypes.func,
    ]),
    /**
     ...
     */
    expandIconProps: PropTypes.oneOfType([
        PropTypes.object,
        PropTypes.func,
    ]),
    /**
     ...
     */
    defaultExpandedRowKeys: PropTypes.arrayOf(PropTypes.oneOfType([
        PropTypes.string,
        PropTypes.number,
    ])),
    /**
     ...
     */
    expandedRowKeys: PropTypes.arrayOf(PropTypes.oneOfType([
        PropTypes.string,
        PropTypes.number,
    ])),
    /**
